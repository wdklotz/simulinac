...
parser.add_argument("-P","--p",    metavar="N", default=1750, type=int,     help="N particles per bunch")
parser.add_argument("--hide",      action="store_true",                     help="hide IN/OUT scatter plots")
parser.add_argument ("-F","--file",default="simuIN_default.yml",            help="lattice input-file")
parser.add_argument("--losses",    action="store_true",                     help="run in losses mode")
parser.add_argument("--pcuts",     action="store_true",                     help="save poincare cuts")
